...
REPO_URL="${REPO_URL:-https://github.com/owner/quotaguard}"
BRANCH="${BRANCH:-main}"
...
echo "2. In Telegram: /settoken [your_bot_token]"
echo "3. Use /qg_status, /qg_fallback, /qg_thresholds, /qg_policy"
echo "4. Import accounts: ./quotaguard setup ${AUTH_PATH:-/path/to/auths}"
